    ...
    return(
        <div className="max-w-[1200px] m-auto p-2">
            <div className="max-w-full md:w-2/3 lg:w-2/4 primary-bg p-10 m-auto mt-20 rounded-md">
                ...
                <form method="post" name="login--form" className="custominput">
                    ...
                    <button type="button" className="primary-btn px-6 py-2 capitalize mt-5 w-full text-xl" onClick={handleLogIn}>Log in</button>
                </form>
